...
### Глава 1: Датасеты и симуляция ошибок (data/)
...
### Глава 4: Сравнительный анализ (benchmarks/)
...
### Глава 5: Коррекция аналоговых сигналов (отдельный трек)
